	...
	<div class="container register">
		<div class="row">
			<div class="col-md-3 register-left">
				<h3>Welcome</h3>
				<p>You are 30 seconds away from saving your own money!</p>
			</div>
			<div class="col-md-9 register-right ">
				...
				<div class="tab-content" id="myTabContent">
					<div class="tab-pane fade show active" id="home" role="tabpanel"
						...
						<form:form action="./registerCustomer" modelAttribute="custModel">
							<div class="row register-form">
								<div class="col-md-6">
									<div class="form-group">
										<form:input type="text" path="cust_name" required="required"
									...
									<div class="form-group">
										<form:input type="email" class="form-control"
											...
											placeholder="Your Email *" value="" path="cust_email" />
									</div>
									...
									<div class="form-group" id="setCustType">
										<form:select class="form-control" path="cust_type"
											...
											<option disabled class="hidden" selected
									...
									<div class="form-group">
										<div class="maxl">
											<label class="radio inline"> <form:radiobutton
													path="isActive" value="true" required="required" /> <span>
													Active </span>
											</label> <label class="radio inline"> <form:radiobutton
									...
									<div class="form-group">
										<div class="maxl">
											<label class="radio inline"> <form:radiobutton
													path="isAdmin" value="true" required="required" /> <span>
													isAdmin </span>
											</label> <label class="radio inline"> <form:radiobutton
